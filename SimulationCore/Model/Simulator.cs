...
namespace SimulationCore.Model
{
    ...
    public class Simulator
    {
        ...
        public Simulator(
            ...
            DateTime startDate,
            DateTime stopDate,
            bool setInitialBookCost,
            bool forceInitialRebalancing)
        {
            ...
            this.Portfolio = new Portfolio(initialPortfolio);
            this.InitialPortfolioValue = this.Portfolio.BookValue;

            if (setInitialBookCost)
            {
            ...
            if (forceInitialRebalancing)
            {
                Log.InfoFormat("Performing initial rebalancing on {0:D}", this.CurrentDate);
                this.TradePlan = this.Portfolio.RebalancingStrategy.Rebalance(this.Portfolio);
            }

            this.InitialPortfolio = new Portfolio(this.Portfolio);
        }
        ...
        /// <summary>
        /// Gets or sets initial portfolio value. If not specified the portfolio
        /// book value is used.
        /// </summary>
        ...
        public ModelPortfolio PortfolioModel
        {
            get
            {
                return this.Portfolio.ModelPortfolio;
            }
        }

        /// <summary>
        /// Gets or sets a schedule at which simulation stops and allows caller
        /// to perform rebalancing. Default schedule is not specified is daily.
        /// </summary>
        public ISchedule Schedule { get; set; }

        /// <summary>
        /// Gets or sets simulation start date.
        /// </summary>
        ...
        public PortfolioStats CalculatePortfolioStats()
        {
            ...
            var totalReturn = this.Portfolio.MarketValue - this.InitialPortfolioValue + dividendsPaid
                              - managementExpenses;
            var totalReturnRate = totalReturn / this.InitialPortfolioValue;
            var period = this.CurrentDate.Subtract(this.StartDate);
        ...
        public void DefaultScheduleHandler()
        {
            ...
            var result = this.Portfolio.RebalancingStrategy.Check(this.Portfolio);
            if (result)
            {
